 ...
 */
final class Version20210607144809 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE address (id INT AUTO_INCREMENT NOT NULL, pool_id INT DEFAULT NULL, reaction_id INT DEFAULT NULL, company VARCHAR(255) DEFAULT NULL, street VARCHAR(255) DEFAULT NULL, street_format VARCHAR(255) DEFAULT NULL, zip VARCHAR(255) DEFAULT NULL, city VARCHAR(255) DEFAULT NULL, country VARCHAR(255) DEFAULT NULL, gender VARCHAR(255) DEFAULT NULL, first_name VARCHAR(255) DEFAULT NULL, last_name VARCHAR(255) DEFAULT NULL, status VARCHAR(255) DEFAULT NULL, phone VARCHAR(255) DEFAULT NULL, email VARCHAR(255) DEFAULT NULL, comment LONGTEXT DEFAULT NULL, position VARCHAR(255) DEFAULT NULL, title VARCHAR(255) DEFAULT NULL, file_url VARCHAR(255) DEFAULT NULL, var1 VARCHAR(255) DEFAULT NULL, var2 VARCHAR(255) DEFAULT NULL, var3 VARCHAR(255) DEFAULT NULL, var4 VARCHAR(255) DEFAULT NULL, var5 VARCHAR(255) DEFAULT NULL, blacklist TINYINT(1) NOT NULL, INDEX IDX_D4E6F817B3406DF (pool_id), INDEX IDX_D4E6F81813C7171 (reaction_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE campaign (id INT AUTO_INCREMENT NOT NULL, template_id INT DEFAULT NULL, pool_id INT DEFAULT NULL, date VARCHAR(255) NOT NULL, file VARCHAR(255) DEFAULT NULL, INDEX IDX_1F1512DD5DA0FB8 (template_id), INDEX IDX_1F1512DD7B3406DF (pool_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE name_genger (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, gender VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE pool (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, color VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE name_genger');
